...
dir_path = "/Users/amina/Desktop/um6p_greedy/code/laplacian/"
...
errPlot(np.arange(len(st_errors))+1, st_errors, "iteration", "Error", 1, 1, "s", "k", "Strong greedy", "Heat equation")
errPlot(np.arange(len(pr_errors))+1, pr_errors, "iteration", "Error", 1, 1, "*", "r", "Predictive greedy", "Heat equation")
"""
errPlot(np.arange(len(st_err))+1, st_err, "iteration", "Error", 1, 1, "*", "g", "Strong greedy", "Heat equation")
